...
<html lang="en">
  ...
  <title>Daftar &mdash; SPP Mahardhika</title>
        ...
        <div class="row">
          <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
            <div class="login-brand">
              <img src="assets2/img/avatar/avatar-1.png" alt="logo" width="100" class="shadow-light rounded-circle">
            </div>
            ...
            <div class="simple-footer">
              Copyright &copy; Wina Lestari 2021
            </div>
          </div>
        </div>
      </div>
