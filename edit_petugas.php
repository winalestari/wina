...
?>
        ...
        <section class="section">
          <div class="section-header bg-light">
            <h1>Edit Petugas Nama <?php echo $data['nama_petugas']; ?></h1>
              ...
              <div class="col-12">
                <div class="card bg-light">
                  <div class="card-header">
                    <h4>SILAHKAN EDIT PETUGAS DISINI</h4>
                  </div>
                  <div class="card-body">
                    <div class="row mt-4">
                     ...
                     <select  class="form-control" name="level">
                      <?php
                       $idpetugasyangdipilih=$data['id_petugas']; 
                          ...
                          {
                          ?>
                      <option class="value="<?php echo $row['id_petugas']; ?>" <?php if($row['id_petugas']=="$idpetugasyangdipilih"){?> selected="selected" <?php } ?>><?php echo $row['level']; ?></option>
                     <?php
